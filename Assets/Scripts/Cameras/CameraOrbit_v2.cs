...
namespace SocialPoint.Tools
{
    public class CameraOrbit_v2 : MonoBehaviour
    {
        ...
        private bool directionIsSetted = false;
        private float dir;

        //private Vector2 t0CurrentPos = Vector2.zero;
        //private float oldDist = 0;
        //private float t0accumDist = 0;

        public Text aaa,bbb, ccc, ddd, eee;
        ...
        private void TwoFingersBehaviour()
        {
            if (Input.touchCount == 2)
            {
                ...
                if (dotProduct > 0 || dotProduct == -1) PanCamera_Device(t0, t1);
                else if (dotProduct < 0)                ZoomCamera_Device(t0, t1);

                bbb.text = dotProduct.ToString();
            }
        }

        private void ZoomCamera_Device(Touch t0, Touch t1)
        {
            aaa.text = "ZOOM";
            ...
            distance += difference * zoomSensibility * distance / ZOOM_SENSIBILITY;
