...
namespace SocialPoint.Tools.FlyThrough
{
    ...
    {
        private FlyThroughManager_OLD ftm;

        public StartEndNode(Rect rect, TypeOfNode typeOfNode, Action<BaseNode> OnClickRemoveNode, string title, string name, GUID id, FlyThroughManager_OLD ftm)
        {
